...
export function ContributionChartGenerator() {
  ...
  const themeOptions: ThemeOption[] = [
    { id: "github", name: "GitHub", colors: ["#ebedf0", "#9be9a8", "#40c463", "#30a14e", "#216e39"] },
    { id: "github-dark", name: "GitHub Dark", colors: ["#161b22", "#0e4429", "#006d32", "#26a641", "#39d353"] },
    { id: "github-light", name: "GitHub Classic", colors: ["#ebedf0", "#c6e48b", "#7bc96f", "#239a3b", "#196127"] },
    { id: "halloween", name: "Halloween", colors: ["#ebedf0", "#ffee4a", "#ffc501", "#fe9600", "#03001c"] },
    { id: "teal", name: "Teal", colors: ["#ebedf0", "#bef5cb", "#85e0ab", "#34b27a", "#137356"] },
    { id: "leftpad", name: "Leftpad", colors: ["#ebedf0", "#c8e6c9", "#a5d6a7", "#66bb6a", "#4caf50"] },
    { id: "dracula", name: "Dracula", colors: ["#282a36", "#44475a", "#6272a4", "#bd93f9", "#ff79c6"] },
    { id: "blue", name: "Blue", colors: ["#ebedf0", "#b0e0e6", "#87ceeb", "#4682b4", "#0000cd"] },
    { id: "panda", name: "Panda", colors: ["#ebedf0", "#c8e6c9", "#a5d6a7", "#66bb6a", "#000000"] },
    { id: "sunny", name: "Sunny", colors: ["#ebedf0", "#fff9c4", "#fff59d", "#fff176", "#ffeb3b"] },
    { id: "pink", name: "Pink", colors: ["#ebedf0", "#f8bbd0", "#f48fb1", "#f06292", "#e91e63"] },
    { id: "yingnbu", name: "YlGnBu", colors: ["#ebedf0", "#eaf5f9", "#c7e9b4", "#41b6c4", "#253494"] },
    { id: "solarized-dark", name: "Solarized Dark", colors: ["#002b36", "#073642", "#586e75", "#657b83", "#839496"] },
    { id: "solarized-light", name: "Solarized Light", colors: ["#fdf6e3", "#eee8d5", "#93a1a1", "#839496", "#657b83"] },
  ]
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="text-center">GitHub Contributions Chart Generator</CardTitle>
