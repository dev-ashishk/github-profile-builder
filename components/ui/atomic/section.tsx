...
export function SectionHeading({ children, className, color, level = 2 }: SectionHeadingProps) {
  const styles = {
  ...
  switch (level) {
    ...
    case 2:
      return (
        <h2 className={cn("text-xl font-semibold mb-3", className)} style={styles}>
          {children}
        </h2>
      )
    case 3:
      return (
        <h3 className={cn("text-lg font-medium mb-2", className)} style={styles}>
          {children}
        </h3>
      )
    default:
